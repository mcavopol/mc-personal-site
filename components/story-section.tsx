      ...
      <div className="space-y-12">
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl">
              ...
              <a
                ...
                aria-label="Learn more about my superpower"
              >
                superpower
              </a>
          ...
          >
            ...
            <div ref={timelineRef} className="space-y-12 md:space-y-0" id="career-timeline">
              <TimelineCard
                age="9"
                year="1996"
...
Revenue growth tripled, from under 5% to 30-40% YoY, while attracting strategic acquirers in point-of-sales systems.`}
                achievements={["Bootstrapped channel revenue to 40% of MRR and 10x'd TAM", "30% annual revenue growth"]}
                isLeft={false}
                sector="PLG & Channel"
...
We decreased operating costs 70% through extreme focus on only essential priorities, and achieved profitability.`}
              ...
              <TimelineCard
                ...
                achievements={["3 toy hedgehogs received", "10x ROI delivered", "1 recession navigated (in progress)"]}
                isLeft={false}
